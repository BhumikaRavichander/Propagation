...
threshold = 100
X_train,Y_train = create_train_data(X,Y,start=0,end=10000,threshold=None)
X_test,Y_test = create_test_data(X,Y,start=20000,end=21000,threshold=None)
...
title = f"Task 3: Cost vs iterations plot for learning rate {lr}"
name = 'Task3_0.1.jpg'
